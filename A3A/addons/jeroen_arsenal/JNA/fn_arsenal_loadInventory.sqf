...
_reportReplaced = "";
{
	...
	_reportReplaced = _reportReplaced + _nameOld + localize "STR_antistasi_logistics_JNA_loadinventory_kept" + _nameNew + "\n";
} forEach _arrayReplaced;

if!(_reportReplaced isEqualTo "")then{
	_reportTotal = (localize "STR_antistasi_logistics_JNA_loadinventory_notin_kept" + _reportReplaced+"\n");
};
...
if!(_reportMissing isEqualTo "")then{
	_reportTotal = (_reportTotal + localize "STR_antistasi_logistics_JNA_loadinventory_notin" + _reportMissing+"\n");
};
