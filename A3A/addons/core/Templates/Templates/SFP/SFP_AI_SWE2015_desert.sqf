...
["vehiclesIFVs", ["sfp_strf90c_desert"]] call _fnc_saveToTemplate;                  // capable of surviving multiple rockets, cannon armed, with 6-8 passengers
["vehiclesTanks", ["sfp_strv122"]] call _fnc_saveToTemplate;
["vehiclesAA", ["sfp_lvkv90c_desert"]] call _fnc_saveToTemplate;                    // ideally heavily armed with anti-ground capability and enclosed turret. Passengers will be ignored
