...
//Starting Unlocks
unlockedWeapons append ["hgun_Pistol_heavy_02_F","hgun_P07_F","SMG_01_F","SMG_03_TR_black"];
unlockedRifles append ["SMG_01_F","SMG_03_TR_black"];
initialWeapons append ["SMG_01_F","SMG_03_TR_black"];
unlockedMagazines append ["6Rnd_45ACP_Cylinder","16Rnd_9x21_Mag","30Rnd_45ACP_Mag_SMG_01","50Rnd_570x28_SMG_03","MiniGrenade","SmokeShell","IEDLandBig_Remote_Mag","IEDUrbanBig_Remote_Mag","IEDLandSmall_Remote_Mag","IEDUrbanSmall_Remote_Mag"];
...
unlockedVest append ["V_Chestrig_blk","V_Chestrig_rgr","V_Chestrig_khk","V_Chestrig_oli","V_BandolierB_blk","V_BandolierB_cbr","V_BandolierB_rgr","V_BandolierB_khk","V_BandolierB_oli","V_Rangemaster_belt"];
unlockedItem append ["Binocular","acc_flashlight"];
//TFAR Unlocks
