...
vehicleBox addAction ["Buy Flexible Tank for 80€", {[player, ['vehicleFuelSource', 0], 80, [['A3A_fnc_initMovableObject', 0], ['A3A_fnc_logistics_addLoadAction', 1]]] call A3A_fnc_spawnItem},nil,0,false,true,"","true",4];
vehicleBox addAction ["Buy Huron Container for 1000€", {[player, ['vehicleFuelSource', 1], 1000, [['A3A_fnc_logistics_addLoadAction', 1]]] call A3A_fnc_spawnItem},nil,0,false,true,"","true",4];
