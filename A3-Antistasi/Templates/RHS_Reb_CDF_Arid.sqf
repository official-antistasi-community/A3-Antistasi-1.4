...
initialRebelEquipment append ["Binocular","ACE_Vector","ItemGPS","ItemcTab","acc_flashlight","rhs_acc_2dpzenit","ACE_Fortify","ACE_DeadManSwitch","rhsusf_m112_mag"];
