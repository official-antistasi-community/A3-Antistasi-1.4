...
private _punishmentReleaseTime = [getPlayerUID player, [ ["_sentenceEndTime",0] ]] call A3A_fnc_punishment_dataGet select 0;
if (!isNil "_punishmentReleaseTime" && {_punishmentReleaseTime > serverTime}) exitWith {["Fast Travel", "Nope. Not happening."] call A3A_fnc_customHint;};
