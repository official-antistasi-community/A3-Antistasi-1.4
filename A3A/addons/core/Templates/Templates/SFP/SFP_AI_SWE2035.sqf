...
["vehiclesLightArmed", ["sfp_tgb16_rws"]] call _fnc_saveToTemplate;             // Should be armed, unarmoured to lightly armoured, with 0-4 passengers
...
["vehiclesGunBoats", ["sfp_strb90_rws"]] call _fnc_saveToTemplate;
...
["staticAA", ["sfp_rbs70","sfp_rbs70","sfp_rbs97"]] call _fnc_saveToTemplate;
...
_policeLoadoutData set ["SMGs", ["sfp_mp5", "sfp_cbj_ms"]];
_policeLoadoutData set ["shotguns", ["sfp_remington870", "sfp_remington870_chrome"]];
_policeLoadoutData set ["sidearms", [["sfp_p88", "", "sfp_tlr2", "", ["sfp_17Rnd_9x19_Mag"], [], ""], "sfp_p88"]];
