...
_sfLoadoutData set ["sniHats", ["CUP_H_USMC_BOONIE_WDL"]];
...
_militaryLoadoutData set ["sniHats", ["CUP_H_USMC_BOONIE_WDL"]];
...
_militiaLoadoutData set ["sniHats", ["CUP_H_USMC_BOONIE_WDL"]];
