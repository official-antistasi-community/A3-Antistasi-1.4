    ...
    // Add items
        ...
        _buyableItemList pushBack [
            ...
            [
                ...
                _fuelDrum # 1, 
                [
                    ['A3A_fnc_initObject', false, 1], ['A3A_Logistics_fnc_addLoadAction', false]
                ]
            ], 
            false,
            "Fuel Drum"
        ...
        _buyableItemList pushBack [
            ...
            "HR_GRG_fnc_confirmPlacement", [
                ...
                [
                    ...
                    _medTent  # 1, 
                    [
                        ['A3A_fnc_initObject', false, 5], ['A3A_fnc_openDoorsTent', true]
                    ]
                ]
            ],
            false,
        ...
        _buyableItemList pushBack [
            ...
            "HR_GRG_fnc_confirmPlacement", [
                ...
                [
                    ...
                    _repairStation # 1, 
                    [
                        ['A3A_fnc_initObject', false, 5], ['A3A_Logistics_fnc_addLoadAction', false]
                    ]
                ]
            ],
            false,
        ...
        if (LootToCrateEnabled) then {
            _buyableItemList pushBack [
                ...
                [
                    ...
                    10,
                    [
                        ['A3A_fnc_initObject', false, 3], ['A3A_Logistics_fnc_addLoadAction', false]
                    ]
                ],
                false,
                "Loot Box"
