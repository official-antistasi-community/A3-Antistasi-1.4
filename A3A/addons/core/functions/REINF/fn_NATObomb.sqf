...
_mrkOrig setMarkerTextLocal localize "STR_A3A_fn_NATObomb_init";
...
_mrkDest setMarkerTextLocal localize "STR_A3A_fn_NATObomb_exit";
...
driver _plane sideChat [localize "STR_A3A_fn_NATObomb_run"];
