...
if (!captive _unit) then {_unit groupChat localize "STR_antistasi_undercover_spotted_me"} else {[_unit,false] remoteExec ["setCaptive",0,_unit]; _unit setCaptive false};
