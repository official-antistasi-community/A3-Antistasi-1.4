 ...
 */
 ...
 /*
    ...
    FLOATS CAN ONLY SUPPORT INT VALUES UPTO 16,777,216. NOW THINK
    ...
    MANUALLY FUCKING SUBTRACT PER TIME UNIT. WHY? WHY? WHY? THIS 
    ...
    TERRIBLE WE HAVE IT. IF THIS WAS ANYOTHER LANGUAGE THIS CODE
