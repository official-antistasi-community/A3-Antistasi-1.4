...
if (_typeX == "delete") exitWith {[localize "STR_A3A_core_fn_base_createoutpfia_create", localize "STR_A3A_core_fn_base_createoutpfia_outdated"] call A3A_fnc_customHint;};
