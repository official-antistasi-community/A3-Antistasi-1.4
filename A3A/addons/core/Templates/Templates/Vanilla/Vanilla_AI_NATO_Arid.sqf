...
//"aow","enoch","tank","orange","jets","expansion","mark","heli","kart"
...
if ("tanks" in A3A_enabledDLC) then {
	_Tanks append ["B_AFV_Wheeled_01_cannon_F","B_AFV_Wheeled_01_up_cannon_F"]; //Closer to IFV than tank, but no passanger seats.
};
