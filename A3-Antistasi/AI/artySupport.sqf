...
[theBoss,"sideChat",_textX] remoteExec ["A3A_fnc_commsMP",[rebelSide,civilian]];
...
if (_typeArty == "BARRAGE") then
	...
	[petros,"sideChat",_textX]remoteExec ["A3A_fnc_commsMP",[rebelSide,civilian]];
	[_timeX] spawn
		{
		private ["_timeX"];
		_timeX = _this select 0;
		waitUntil {sleep 1; time > _timeX};
		[petros,"sideChat","Splash. Out"] remoteExec ["A3A_fnc_commsMP",[rebelSide,civilian]];
		};
	};
