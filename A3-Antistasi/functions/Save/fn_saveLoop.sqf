...
private ["_hrBackground","_resourcesBackground","_veh","_typeVehX","_weaponsX","_ammunition","_items","_backpcks","_containers","_arrayEst","_posVeh","_dierVeh","_occupantSupport","_rebelSupport","_city","_dataX","_markersX","_garrison","_arrayMrkMF","_arrayOutpostsFIA","_positionOutpost","_typeMine","_posMine","_detected","_typesX","_exists","_friendX"];
...

{
	...
	_occupantSupport = _occupantSupport + [_dataX select 2];
	_rebelSupport = _rebelSupport + [_dataX select 3];
} forEach citiesX;

["aggressionOPFOR", _occupantSupport] call A3A_fnc_setStatVariable;
["aggressionBLUFOR", _rebelSupport] call A3A_fnc_setStatVariable;
