...
"6Rnd_45ACP_Cylinder","9Rnd_45ACP_Mag","30Rnd_9x21_Mag_SMG_02","4Rnd_12Gauge_Pellets","MiniGrenade","SmokeShell",
...
if ("orange" in A3A_enabledDLC) then {_dlcUniforms append [
    "U_IG_Guerilla1_2_F"
];
};
