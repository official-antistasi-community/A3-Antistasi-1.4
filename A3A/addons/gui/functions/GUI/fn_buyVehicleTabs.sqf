    ...
    // Add items
        ...
        _buyableItemList pushBack [
            ...
            [
                ...
                _fuelDrum # 1, 
                [
                    ['A3A_fnc_initObject', false, MOVE_OBJ + LOADABLE]
                ]
            ], 
            false,
            "Fuel Drum"
        ...
        _buyableItemList pushBack [
            ...
            "HR_GRG_fnc_confirmPlacement", [
                ...
                [
                    ...
                    _medTent  # 1, 
                    [
                        ['A3A_fnc_initObject', false, MOVE_OBJ + PACKABLE], ['A3A_fnc_openDoorsTent', true]
                    ]
                ]
            ],
            false,
        ...
        _buyableItemList pushBack [
            ...
            "HR_GRG_fnc_confirmPlacement", [
                ...
                [
                    ...
                    _repairStation # 1, 
                    [
                        ['A3A_fnc_initObject', false, MOVE_OBJ + PACKABLE + LOADABLE]
                    ]
                ]
            ],
            false,
        ...
        if (LootToCrateEnabled) then {
            _buyableItemList pushBack [
                ...
                [
                    ...
                    10,
                    [
                        ['A3A_fnc_initObject', false, MOVE_OBJ + LOOT_CRATE + LOADABLE]
                    ]
                ],
                false,
                "Loot Box"
        ...
        _buyableItemList pushBack [
            ...
            [
                ...
                25,
                [
                    ['A3A_fnc_initObject', false, MOVE_OBJ]
                ]
            ], 
            false,
            "Light"
