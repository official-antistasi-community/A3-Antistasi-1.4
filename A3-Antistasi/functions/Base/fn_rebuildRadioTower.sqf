...
// Parameter should be present in A3A_antennasDead array
...
if !(_antenna in A3A_antennasDead) exitWith { Error("Attempted to rebuild invalid radio tower") };
Info_1("Repairing Antenna %1", str _antenna);

A3A_antennasDead = A3A_antennasDead - [_antenna]; publicVariable "A3A_antennasDead";
