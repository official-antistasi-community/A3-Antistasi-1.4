...
_sfLoadoutData set ["uniforms", ["CUP_U_B_BAF_MTP_UBACSLONG","CUP_U_B_BAF_MTP_UBACSLONG_Gloves","CUP_U_B_BAF_DDPM_UBACSLONG","CUP_U_B_BAF_DDPM_UBACSSEAL","CUP_U_B_BAF_DDPM_UBACSTSHIRT_Gloves"]];
