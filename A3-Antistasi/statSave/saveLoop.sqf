if (hasInterface) then {
	if (!isNil "savingClient" && {savingClient}) exitWith {["Save Game", "Your personal stats are being saved"] call A3A_fnc_customHint;};
...
[petros,"hint",_saveHintText, "Save Game"] remoteExec ["A3A_fnc_commsMP", 0];
