...
[localize "STR_A3A_core_fn_base_gc_title", format [localize "STR_A3A_core_fn_base_gc_wait", _timeSinceLastGC]] remoteExec ["A3A_fnc_customHint", 0];
...
// Do not localise timeSpan, it is broadcast to all connected clients.
[localize "STR_A3A_core_fn_base_gc_title", format [localize "STR_A3A_core_fn_base_gc_deleted", _timeSinceLastGC]] remoteExec ["A3A_fnc_customHint", 0];
