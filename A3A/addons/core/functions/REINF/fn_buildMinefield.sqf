...
_costs = 2*(server getVariable _typeExp) + ([selectRandom (FactionGet(reb,"vehicleTruck"))] call A3A_fnc_vehiclePrice);
...
private _truckXType = selectRandom (FactionGet(reb,"vehicleTruck"));
