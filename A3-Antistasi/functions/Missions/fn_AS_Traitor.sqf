...
[[teamPlayer,civilian],_taskID,[format [localize "STR_antistasi_mission_traitor_text",_nameDest,_displayTime,nameOccupants],localize "STR_antistasi_mission_traitor_name",_markerX],_posTsk,false,0,true,"Kill",true] call BIS_fnc_taskCreate;
[[Occupants],_taskID+"B",[format [localize "STR_antistasi_mission_protectContact_text",_nameDest,_displayTime,nameTeamPlayer],localize "STR_antistasi_mission_protectContact",_markerX],getPos _houseX,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
