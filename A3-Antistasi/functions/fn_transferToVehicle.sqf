...
systemChat format ["7CAV Cavastasi Looter: from %1 into %2", _targetTypeStr, getText (configFile >> "CfgVehicles" >> typeOf _vehicle >> "displayname")];
...
if (_isMan) then {
	...
	if (_target call A3A_fnc_getRadio != "") then {
