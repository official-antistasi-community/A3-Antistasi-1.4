...
if (count hcArray == 0) exitWith {[(call A3A_fnc_getPetros),"hint","No Headless Client Detected"] remoteExec ["A3A_fnc_commsMP",theBoss]};
_textX = "";
...
[(call A3A_fnc_getPetros),"hint",_textX] remoteExec ["A3A_fnc_commsMP",theBoss];