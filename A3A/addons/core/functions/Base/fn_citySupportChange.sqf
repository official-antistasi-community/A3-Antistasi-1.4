...
params [["_changeGov",""], ["_changeReb",""], ["_pos","invalid",["",[]]], ["_scaled", true], ["_isRadio", false]]; // nil protection
...
if (_pos == "invalid") exitWith {Error("The third parameter, the position, must be a string (city name) or array (coordinates)");};
