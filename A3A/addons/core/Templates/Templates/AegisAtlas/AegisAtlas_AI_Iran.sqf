...
["name", "Iran"] call _fnc_saveToTemplate; 						//this line determines the faction name -- Example: ["name", "NATO"] - ENTER ONLY ONE OPTION
["spawnMarkerName", "Iran Support Corridor"] call _fnc_saveToTemplate; 			//this line determines the name tag for the "carrier" on the map -- Example: ["spawnMarkerName", "NATO support corridor"] - ENTER ONLY ONE OPTION
...
["vehiclesPlanesTransport", ["O_Plane_Transport_01_infantry_F"]] call _fnc_saveToTemplate; 	//this line determines transport planes -- Example: ["vehiclesPlanesTransport", ["B_T_VTOL_01_infantry_F"]] -- Array, can contain multiple assets
...
_sfLoadoutData set ["helmets", ["H_HelmetSpecO_ocamo", "H_Cap_brn_SPECOPS_hs", "H_Booniehat_ocamo_hs"]];				//this line determines helmets for special forces -- Example: ["H_HelmetB_camo", "H_HelmetB_desert"] -- Array, can contain multiple assets
...
["arifle_Mk20_hex_F", "", "acc_flashlight", "optic_Aco_", ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag_Tracer_Yellow"], [], ""],
["arifle_Mk20C_hex_F", "", "acc_flashlight", "optic_Aco_", ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag_Tracer_Yellow"], [], ""]
]];
...
_militiaLoadoutData set ["uniforms", ["U_O_officer_noInsignia_hex_F"]];		//this line determines uniforms for military loadouts -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
...
_militiaLoadoutData set ["helmets", ["H_MilCap_ocamo", "H_HelmetO_ocamo", "H_Beret_ocamo"]];
