...
{
    [localize "STR_antistasi_customHint_intel", localize "STR_antistasi_customHint_intel_cancel"] call A3A_fnc_customHint;
...
if(_caller getVariable ["intelFound", false]) then
{
    ...
    if(_hasIntel) then
    {
        [localize "STR_antistasi_customHint_intel", localize "STR_antistasi_customHint_intel_found"] call A3A_fnc_customHint;
    ...
    {
        [localize "STR_antistasi_customHint_intel", localize "STR_antistasi_customHint_intel_no_found"] call A3A_fnc_customHint;
    };
}
else
{
