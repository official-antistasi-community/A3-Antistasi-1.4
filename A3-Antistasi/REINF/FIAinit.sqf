...
if (!activeGREF) then {if (not((uniform _unit) in uniformsSDK)) then {[_unit] call A3A_fnc_reDress}};			// if RHS GREF isnt detected and unit isnt wearing a REBEL uniform from templates then redress him
