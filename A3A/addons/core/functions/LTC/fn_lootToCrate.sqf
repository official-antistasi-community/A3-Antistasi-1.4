...
_targets = nearestObjects [getposATL _container, ["Man"], LootToCreateDistance];
_weaponHolders = nearestObjects [getposATL _container, ["WeaponHolder","WeaponHolderSimulated"], LootToCreateDistance];
