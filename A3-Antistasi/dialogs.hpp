...
class utilities_option 	{
	...
	class controls {
		...
		{
			idc = -1;
			text = $STR_antistasi_utility_box_text;
			x = 0.254979 * safezoneW + safezoneX;
			y = 0.233941 * safezoneH + safezoneY;
			w = 0.425038 * safezoneW;
			h = 0.18 * safezoneH;//28
		...
		class HQ_button_utility: RscButton
		{
			idc = -1;
			text = $STR_antistasi_dialogs_utility_purchase_text;
			tooltip = $STR_antistasi_dialogs_utility_purchase_tooltip;
			x = 0.272481 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0;  if(A3A_hasACE)then{nul = createDialog ""utilities_items"" ;}else {[""Utility Items"", ""ACE needs to be on for access to these items.""] call A3A_fnc_customHint};";//
		};
		class HQ_button_loot: RscButton
		{
			idc = -1;
			text = $STR_antistasi_dialogs_lootbox_text;
			tooltip = $STR_antistasi_dialogs_lootbox_tooltip;
			x = 0.482498 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0; player call A3A_fnc_spawnCrate;";
			
		};
	};
};

class utilities_items	{
	idd=-1;
	movingenable=false;
	...
	class controls {
		...
		class HQ_button_back: RscButton
		{
			...
			w = 0.06 * safezoneW;//0.175015
			h = 0.05 * safezoneH;
			action = "closeDialog 0;_nul = createDialog ""utilities_option"";";
		};
		class HQ_button_Gsquad: RscButton
		{
			idc = -1;
			text = $STR_antistasi_dialogs_jerrycan_buy;
			x = 0.272481 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = $STR_antistasi_dialogs_jerrycan_buy_tooltip;
			action = "closeDialog 0;nul = [player,""SM""] call A3A_fnc_spawnJerrycan;";
		};
		class HQ_button_Gstatic: RscButton
		{
			idc = -1;
			text = $STR_antistasi_dialogs_big_jerrycan_buy;
			x = 0.482498 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = $STR_antistasi_dialogs_big_jerrycan_buy_tooltip;
			action = "closeDialog 0; nul = [player,""BG""] call A3A_fnc_spawnJerrycan;";
		};

		class HQ_button_Gremove: RscButton
		{
			idc = -1;
			text = $STR_antistasi_dialogs_utility_placeholder;
			x = 0.272481 * safezoneW + safezoneX;
			y = 0.415981 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = $STR_antistasi_dialogs_utility_placeholder_tooltip;
			action = "closeDialog 0;";
		};
