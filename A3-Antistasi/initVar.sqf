...
diag_log format ["%1: [Antistasi] | INFO | initVar | Building Launcher list.",servertime];
...
diag_log format ["%1: [Antistasi] | INFO | initVar | Building NightVision list.",servertime];
...
diag_log format ["%1: [Antistasi] | INFO | initVar | Building Vehicle list.",servertime];
