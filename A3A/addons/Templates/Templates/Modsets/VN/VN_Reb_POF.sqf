...
_loadoutData set ["glasses", ["G_Aviator", "G_Spectacles", "G_Spectacles_Tinted"]];
_loadoutData set ["goggles", ["G_Lowprofile"]];
_loadoutData set ["facemask", ["G_Bandanna_blk", "G_Bandanna_oli", "G_Bandanna_khk", "G_Bandanna_tan"]];
