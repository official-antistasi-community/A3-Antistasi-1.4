...
private _LightUnarmed = ["O_MRAP_02_F"]] call _fnc_saveToTemplate;
private _LightArmed = ["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F"]] call _fnc_saveToTemplate;
...
private _Tanks = ["O_MBT_02_cannon_F"] call _fnc_saveToTemplate;
