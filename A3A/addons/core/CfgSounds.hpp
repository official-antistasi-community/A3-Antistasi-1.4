class CfgSounds
{
	...
	class A3A_Audio_Civ_Song3
	{
		...
		sound[] = {EQPATHTOFOLDER(core,Sounds\Civilian\song3.ogg), 0.5, 1, 20};
		titles[] = {};
	};
	...
	class A3A_Audio_Civ_Song4
	{
		...
		sound[] = {EQPATHTOFOLDER(core,Sounds\Civilian\song4.ogg), 0.5, 1, 20};
		titles[] = {};
	};
	...
	class A3A_Audio_Civ_Song5
	{
		...
		sound[] = {EQPATHTOFOLDER(core,Sounds\Civilian\song5.ogg), 0.5, 1, 20};
		titles[] = {};
	};
	...
	class A3A_Audio_Civ_Song6
	{
		...
		sound[] = {EQPATHTOFOLDER(core,Sounds\Civilian\song6.ogg), 0.5, 1, 20};
		titles[] = {};
	};
};