...
private _text = format [localize "STR_antistasi_logistics_private_addweaponaction_getin", _name];
...
private _actionID = _vehicle addAction [
    _text,
    {
        ...
        } else {[localize "STR_antistasi_logistics_logistics", localize "STR_antistasi_logistics_private_addweaponaction_alreadyin"] call A3A_fnc_customHint};
    },
    _cargo,
    5.5,
    true,
