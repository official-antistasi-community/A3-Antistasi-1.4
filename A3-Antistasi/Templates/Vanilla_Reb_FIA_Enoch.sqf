...
civilianVest = ["V_Chestrig_blk","V_Chestrig_rgr","V_Chestrig_khk","V_Chestrig_oli","V_BandolierB_blk","V_SmershVest_01_F","V_BandolierB_rgr","V_SmershVest_01_radio_F","V_BandolierB_oli","V_Rangemaster_belt"];
//TFAR Unlocks
