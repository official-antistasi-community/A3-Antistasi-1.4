if (side petros == west) exitWith {call compile preProcessFileLineNumbers "Templates\rebelBlu3CBUN.sqf"};
if (worldName == "Tanoa") exitWith {call compile preProcessFileLineNumbers "Templates\rebel3CBCCMT.sqf"};
...
if (hasFFAA) then//checks if you have FFAA installed then uses their units
	...
	if (gameMode != 4) then//if you have occupants on your map it uses these
		...
		militiaVehArmed = "UK3CB_BAF_LandRover_WMIK_Milan_FFR_Green_B_DPMW";
		militiaVehTransport = "UK3CB_BAF_MAN_HX60_Cargo_Sand_A_DDPM";
		militiaVehUnarmed = "UK3CB_BAF_LandRover_Snatch_FFR_Green_A_DPMW";
