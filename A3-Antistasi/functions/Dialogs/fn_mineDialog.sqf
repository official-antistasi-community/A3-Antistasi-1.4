...
if ("Mines" in A3A_activeTasks) exitWith {[localize "STR_antistasi_customHint_minefields", localize "STR_antistasi_customHint_minefields_one"] call A3A_fnc_customHint;};
