...
[[teamPlayer,civilian],_taskId,[format [localize "STR_antistasi_mission_rescue_text",_nameDest,_displayTime],localize "STR_antistasi_mission_rescue",_markerX],_positionX,false,0,true,"run",true] call BIS_fnc_taskCreate;
