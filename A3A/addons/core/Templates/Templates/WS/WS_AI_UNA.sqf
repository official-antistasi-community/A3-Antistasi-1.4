...
private _LightArmed = ["a3a_una_MRAP_01_gmg_F", "a3a_una_MRAP_01_hmg_F","a3a_una_Offroad_armor_armed","a3a_una_Offroad_armor_at"];
...
["vehiclesHelisLightAttack", ["B_D_Heli_Light_01_dynamicLoadout_lxWS", "a3a_Heli_Light_02_black_F"]] call _fnc_saveToTemplate;      // Utility helis with fixed or door guns + rocket pods
...
["vehiclesMilitiaLightArmed", ["a3a_una_Offroad_armed","a3a_una_Offroad_at","a3a_una_Offroad_armor_armed","a3a_una_Offroad_armor_at"]] call _fnc_saveToTemplate;
...
if ("expansion" in A3A_enabledDLC) then {
	_LightArmed append ["a3a_una_MRAP_01_gmg_F", "a3a_una_MRAP_01_hmg_F","B_LSV_01_AT_F","B_LSV_01_armed_F"];
};
...
_sfLoadoutData set ["vests", ["V_PlateCarrier1_rgr_noflag_F", "V_PlateCarrier2_rgr_noflag_F", "V_PlateCarrier1_blk", "V_PlateCarrier2_blk"]];
...
_militaryLoadoutData set ["vests", ["V_lxWS_UN_Vest_Lite_F"]];
_militaryLoadoutData set ["Hvests", ["V_lxWS_UN_Vest_F"]];
_militaryLoadoutData set ["backpacks", ["B_Kitbag_cbr", "B_Carryall_cbr"]];
_militaryLoadoutData set ["helmets", ["lxWS_H_PASGT_goggles_UN_F", "lxWS_H_PASGT_basic_UN_F"]];
...
_militiaLoadoutData set ["Hvests", ["V_TacVest_khk", "V_lxWS_UN_Vest_Lite_F"]];
_militiaLoadoutData set ["backpacks", ["B_AssaultPack_cbr"]];
_militiaLoadoutData set ["helmets", ["lxWS_H_ssh40_un"]];
...
_officerLoadoutData set ["vests", ["V_lxWS_UN_Vest_Lite_F"]];
_officerLoadoutData set ["helmets", ["lxWS_H_Beret_Colonel"]];
