...
[[teamPlayer,civilian],_taskId,[format [localize"STR_A3A_mission_DES_Antenna_description",_nameDest,_displayTime,FactionGet(occ,"name")],localize"STR_A3A_mission_DES_Antenna_title",_mrkFinal],_positionX,false,0,true,"Destroy",true] call BIS_fnc_taskCreate;
