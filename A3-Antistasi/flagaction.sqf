...
switch _typeX do
	...
	case "seaport": {_flag addAction ["Buy Boat", {[rebelVehBoat] spawn A3A_fnc_rebelVehCreate},nil,0,false,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull])",4]};
