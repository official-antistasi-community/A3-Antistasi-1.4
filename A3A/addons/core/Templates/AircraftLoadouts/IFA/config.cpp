    ...
    class Loadouts
    {
        class CASPlane
        {
            ...
            class LIB_FW190F8_2 : baseCAS {
                loadout[] = {"LIB_1Rnd_SC50","LIB_1Rnd_SC50","LIB_1Rnd_SC250","LIB_1Rnd_SC50","LIB_1Rnd_SC50", "LIB_2000Rnd_MG131_FW190","LIB_500Rnd_MG151_FW190"};
                mainGun[] = {"LIB_2xMG131_FW190","LIB_2xMG151_FW190"};
                rocketLauncher[] = {"LIB_2xMG151_FW190"};
                bombRacks[] = {"LIB_SC250_Bomb_Mount","LIB_SC50_Bomb_Mount"};
            ...
            class LIB_P47 : baseCAS {
                ...
                diveParams[] = {1200, 350, 110, 55, 15, [0, 0]};
            };
