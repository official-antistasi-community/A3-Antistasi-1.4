        ...
        case DESPAWN:
        {
            ...
            do
            {
                ...
                case (_marker in factories):
                {
                    ...
                    [[_marker, 4, 4], "A3A_fnc_createAmbientCivRes"] call A3A_fnc_scheduler;
                };
    ...
    do
    {
        ...
        case DESPAWN:
        {
            ...
            do
            {
                ...
                {
                    [[_marker], "A3A_fnc_createAIresources"] call A3A_fnc_scheduler;
                    [[_marker, 4], "A3A_fnc_createAmbientCivRes"] call A3A_fnc_scheduler;
                };
...
private _processCityCivMarker = {
    ...
    do
    {
        ...
        case DESPAWN:
        {
            ...
            {
                [[_marker, 6], "A3A_fnc_createAmbientCivCity"] call A3A_fnc_scheduler;
