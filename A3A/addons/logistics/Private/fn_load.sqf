...
if (_vehicle getVariable ["LoadingCargo", false]) exitWith {[localize "STR_antistasi_logistics_logistics", localize "STR_antistasi_logistics_private_load_being"] remoteExec ["A3A_fnc_customHint", remoteExecutedOwner]; nil};
