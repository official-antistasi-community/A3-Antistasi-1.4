...
if (_nodes isEqualTo []) exitWith {localize "STR_antistasi_logistics_dev_gencargo_lacknodes"};
...
if (count _nodes < _size) exitWith {localize "STR_antistasi_logistics_dev_gencargo_lackcapacity" + str count _nodes};
if (_isWeapon && 0 == getNumber (_nodeConfig/"canLoadWeapon")) exitWith {localize "STR_antistasi_logistics_dev_gencargo_lackavailability"};
