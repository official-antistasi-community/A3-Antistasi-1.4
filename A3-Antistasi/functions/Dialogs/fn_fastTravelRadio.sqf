...
if (!isNil "A3A_FFPun_Jailed" && {(getPlayerUID player) in A3A_FFPun_Jailed}) exitWith {[localize "STR_antistasi_customHint_fast_travel", localize "STR_antistasi_customHint_fast_trevel_nope"] call A3A_fnc_customHint;};
