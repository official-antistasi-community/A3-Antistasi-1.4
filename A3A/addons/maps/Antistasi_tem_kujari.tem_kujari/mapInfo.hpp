class tem_kujari {
	...
	garrison[] = {
		{},{"airport_0","outpost_8","outpost_16","outpost_19","resource_0","resource_1","resource_2"},{},{"control_1","control_2","control_3","control_4","control_5","control_6","control_7","control_8"}
	};
	fuelStationTypes[] = {
