class A3A
{
	...
	class CREATE
	{
        ...
        class createREBELGarrisons {file="CREATE\createREBELGarrison.sqf";};
        class createREBELgarrisonsTemp {file="CREATE\createREBELgarrisonTemp.sqf";};
        ...
        class REBELinit {file="CREATE\REBELinit.sqf";};
