...
["vehiclesHelisTransport", []] call _fnc_saveToTemplate;        // bigger heli with more passengers. Should be capable of dealing damage to                                                                    // ground targets without additional scripting
