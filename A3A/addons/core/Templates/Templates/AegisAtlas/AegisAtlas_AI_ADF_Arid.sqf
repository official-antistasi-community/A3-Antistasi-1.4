...
_sfLoadoutData set ["uniforms", ["Atlas_U_B_A_CombatUniform_aucamo_ard", "Atlas_U_B_A_CombatUniform_shortsleeve_aucamo_ard"]];
_sfLoadoutData set ["vests", ["V_PlateCarrier1_aucamo_ard_F", "V_TacVest_oli"]];
_sfLoadoutData set ["Hvests", ["V_PlateCarrier2_aucamo_ard_F"]];
_sfLoadoutData set ["backpacks", ["B_AssaultPack_aucamo_F", "B_Carryall_aucamo", "B_Kitbag_aucamo_F"]];
_sfLoadoutData set ["helmets", ["H_HelmetHBK_aucamo_arid_chops_F", "H_HelmetHBK_aucamo_arid_ear_F", "H_Booniehat_khk_hs", "H_Watchcap_khk_hs"]];
...
_militaryLoadoutData set ["uniforms", ["Atlas_U_B_A_CombatUniform_aucamo_ard", "Atlas_U_B_A_CombatUniform_shortsleeve_aucamo_ard"]];
_militaryLoadoutData set ["vests", ["V_PlateCarrier1_aucamo_ard_F"]];
_militaryLoadoutData set ["Hvests", ["V_PlateCarrier2_aucamo_ard_F"]];
_militaryLoadoutData set ["glVests", ["V_PlateCarrierGL_aucamo_ard_F"]];
_militaryLoadoutData set ["backpacks", ["B_AssaultPack_aucamo_F", "B_Carryall_aucamo", "B_Kitbag_aucamo_F"]];
_militaryLoadoutData set ["helmets", ["H_HelmetHBK_aucamo_arid_F", "H_HelmetHBK_aucamo_arid_headset_F"]];
...
_militiaLoadoutData set ["vests", ["V_Chestrig_rgr", "V_PlateCarrier1_aucamo_ard_F"]];
_militiaLoadoutData set ["backpacks", ["B_AssaultPack_aucamo_F"]];
_militiaLoadoutData set ["helmets", ["H_HelmetHBK_aucamo_arid_F", "H_MilCap_aucamo", "H_Bandanna_khk_hs"]];
...
_crewLoadoutData set ["uniforms", ["Atlas_U_B_A_CombatUniform_shortsleeve_aucamo_ard"]];
_crewLoadoutData set ["vests", ["V_PlateCarrier1_aucamo_ard_F"]];
...
_pilotLoadoutData set ["uniforms", ["Atlas_U_B_A_CombatUniform_shortsleeve_aucamo_ard"]];
