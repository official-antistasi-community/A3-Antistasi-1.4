...
[[teamPlayer,civilian,Occupants],_taskId,[format [localize "STR_A3A_fn_invaderPunish_long",_nameDest,FactionGet(inv,"name")],format [localize "STR_A3A_fn_invaderPunish_title",FactionGet(inv,"name")],_mrkDest],_posDest,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
