...
if (_unit getVariable ["helping",false]) exitWith {_unit groupChat [localize "STR_A3A_fn_autoLoot_noHelping"]};
_rearming = _unit getVariable "rearming";
if (_rearming) exitWith {_unit groupChat [localize "STR_A3A_fn_loot_noDoing"]; _unit setVariable ["rearming",false]};
if (_unit == gunner _truckX) exitWith {_unit groupChat [localize "STR_A3A_fn_autoLoot_noStatic"]};
if (!canMove _truckX) exitWith {_unit groupChat [localize "STR_A3A_fn_autoLoot_noRepairs"]};
...
if (count _objectsX == 0) exitWith {_unit groupChat [localize "STR_A3A_fn_autoLoot_noCorpses"]};
...
if (isNull _target) exitWith {_unit groupChat [localize "STR_A3A_fn_autoLoot_noLoot"]};
_target setVariable ["busy",true];
_unit setVariable ["rearming",true];
_unit groupChat [localize "STR_A3A_fn_autoLoot_startLoot"];
...
if (!_continuar) then
	{
	_unit groupChat [localize "STR_A3A_fn_autoLoot_noWeapons"]
	};
