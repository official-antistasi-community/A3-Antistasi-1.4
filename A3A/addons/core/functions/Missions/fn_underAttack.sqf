...
[_sideX,_markerX,[format [localize "STR_A3A_mission_Under_Attack_description",_nameDest,_nameENY],format [localize "STR_A3A_mission_Under_Attack_title",_nameENY],_markerX],getMarkerPos _markerX,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
