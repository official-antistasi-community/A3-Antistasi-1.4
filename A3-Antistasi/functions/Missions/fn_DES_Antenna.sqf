...
[[teamPlayer,civilian],_taskId,[format [localize "STR_antistasi_mission_antena_text",_nameDest,_displayTime,nameOccupants],localize "STR_antistasi_mission_antena",_mrkFinal],_positionX,false,0,true,"Destroy",true] call BIS_fnc_taskCreate;
