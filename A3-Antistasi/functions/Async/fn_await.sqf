...
[_varName, _this, _function] remoteExecCall ["A3A_fnc_handleAwait", _target];
...
if (isNil _varName) then {Error("Await timed out after 5 secounds | Function: "+ str _function +" | Target "+ str _target); [_varName] call A3A_fnc_handleAwaitFail};
