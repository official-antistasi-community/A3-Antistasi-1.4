...
unlockedMagazines append ["6Rnd_45ACP_Cylinder","9Rnd_45ACP_Mag","2Rnd_12Guage_Pellets","2Rnd_12Guage_Slug","30Rnd_9x21_Mag_SMG_02","MiniGrenade",,"SmokeShell","HandGrenade_Stone","IEDLandBig_Remote_Mag","IEDUrbanBig_Remote_Mag","IEDLandSmall_Remote_Mag","IEDUrbanSmall_Remote_Mag"];
...
initVest = ["V_Chestrig_blk","V_Chestrig_rgr","V_Chestrig_khk","V_Chestrig_oli","V_BandolierB_blk","V_SmershVest_01_F","V_BandolierB_rgr","V_SmershVest_01_radio_F","V_BandolierB_oli","V_Rangemaster_belt"];
//TFAR Unlocks
