...
fnc_debugv2_overwrite = {
	...
	_ctrl_title ctrlsettext localize "STR_antistasi_logistics_JND_title";
	...
	private _array = [
			[
				...
				localize "STR_antistasi_logistics_JND_button_load",
				_spacingY,
				_button_length,
				{
					params ["_index"];
				...
				localize "STR_antistasi_logistics_JND_button_save",
				_spacingY,
				_button_length,
				{
					params ["_index"];
				...
				localize "STR_antistasi_logistics_JND_button_del",
				_spacingY*10,
				_button_length,
				{
					params ["_index"];
	...
	_ctrl ctrlCommit 0;
	_ctrl ctrlSetText localize "STR_antistasi_logistics_JND_button_undo";
	_ctrl ctrlAddEventHandler ["ButtonClick", {
