...
if !((count _personalGarage < personalGarageMax) or (personalGarageMax isEqualTo 0)) exitWith {["Garage", "Personal garage is full, you cant add more vehicles to it"] call A3A_fnc_customHint};
