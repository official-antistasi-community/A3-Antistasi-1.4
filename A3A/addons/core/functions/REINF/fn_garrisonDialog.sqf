...
if (_typeX == "rem") then
	...
	if (str (_display) != "no display") then
		...
		_ChildControl  ctrlSetTooltip format ["Cost: %1 €",(server getVariable FactionGet(reb,"unitCrew")) + ([selectRandom (FactionGet(reb,"staticMortar"))] call A3A_fnc_vehiclePrice)];
