...
private _initialRebelEquipment = ["LIB_WaltherPPK", "LIB_7Rnd_765x17_PPK"];
...
["headgear", ["H_LIB_CIV_Villager_Cap_2"]] call _fnc_saveToTemplate;          //Headgear used by Rebell Ai until you have Armored Headgear.
